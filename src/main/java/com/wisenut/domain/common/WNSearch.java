...
public class WNSearch {
	...
	public WNSearch() {
		...
		this.mergeCollections=null;
		this.searchFields=null;
		this.searcherId=null;
		this.managerURL=null;
		this.hiSum=0;
		this.connectionOpt=0;
		this.sb=null;
		...
		this.isDebug=false;
		this.isDebug=false;
		this.isUidSrch=false;
		this.resultType=0;
		
		this.realTimeKeywords=null;
		this.suggestedQuery=null;
	}
	
	/**
	 * WNCommon��ü�� �����ϰ� �˻� ��� �÷��ǰ� �˻� ��� �ʵ���� �����Ѵ�.
	 * @param searcherId �˻� ��� sc id
	 * @param isDebug �˻������� ȭ�鿡 ����� ������ ���θ� ����
	 * @param isUidSrch Ű���� �˻��� �� ������ UID �˻��� �� ������ ���θ� ����
	 * @param collections �˻��ϰ��� �ϴ� �÷��ǵ��� Array�� �����Ѵ�.
	 * @param searchFields �˻��ϰ��� �ϴ� �˻��ʵ���� Array�� �����Ѵ�.
	 */
	 ...
	 * @param isUidSrch Ű���� �˻��� �� ������ UID �˻��� �� ������ ���θ� ����
	 * @param collections �˻��ϰ��� �ϴ� �÷��ǵ��� Array�� �����Ѵ�.
	 * @param mergeCollections �˻��ϰ��� �ϴ� ���������÷����� Array�� �����Ѵ�.
	 * @param searchFields �˻��ϰ��� �ϴ� �˻��ʵ���� Array�� �����Ѵ�.
	 * @param resultType �˻������ ��ȯ�ް��� �ϴ� ������ ����
	 */
	public WNSearch(String searcherId, boolean isDebug, boolean isUidSrch, 
